...
**Timeout**: Each experiment should take ~35 minutes total (30 min training + eval/render overhead). If a run exceeds 90 minutes, kill it and treat it as a failure.
