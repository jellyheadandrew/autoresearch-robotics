...
**Timeout**: Each experiment should take ~1.5 minutes total (10 sec training + eval/render overhead). If a run exceeds 60 minutes, kill it and treat it as a failure.
